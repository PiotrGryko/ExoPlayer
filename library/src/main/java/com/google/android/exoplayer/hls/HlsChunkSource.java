...
public class HlsChunkSource implements HlsTrackSelector.Output {
    ...
    public void getChunkOperation(TsChunk previousTsChunk, long playbackPositionUs,
        ...
        if (chunkIndex >= mediaPlaylist.segments.size()) {
            ...
            // else
             if (shouldRerequestLiveMediaPlaylist(nextVariantIndex)) {
                out.chunk = newMediaPlaylistChunk(nextVariantIndex);
                Log.d(TAG,"new media playlsit chunk");
            }
            return;
        }

        HlsMediaPlaylist.Segment segment = mediaPlaylist.segments.get(chunkIndex);
        Log.d("XXX","segment grabbed "+chunkIndex);
        ...
        //if(previousTsChunk!=null)
        //    Log.d("xxx","prevoius chunk index: "+previousTsChunk.chunkIndex);
        ...
        /*
        Log.d("xxx","out chunk data:\ntrigger: "+trigger+
                "\nstartTimeUs: "+startTimeUs+
        "\nendTimeUs: "+endTimeUs+
        "\nchunk media sequence: "+chunkMediaSequence);
*/
