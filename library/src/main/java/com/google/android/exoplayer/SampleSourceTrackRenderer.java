...
public abstract class SampleSourceTrackRenderer extends TrackRenderer
{
    ...
    {
        if (enabledSource != null && enabledSource instanceof HlsSampleSource) {
            durationUs = ((HlsSampleSource) enabledSource).getDuration();

           // Log.d("zzz", "sample source get duration " + durationUs + " class: " + enabledSource.getClass().getName());
